                ...
                .html()
                    ...
                    .body().attrOnload("changeGraphique()")
                        ...
                        .div().attrStyle("margin-top: 5%; display: flex; flex-direction: column;")
                            ...
                            .p().attrStyle("margin: auto; margin-top: 80px;").text("WorkTeamStatus (WTS) | Vous pouvez selectionner plusieurs type de graphiques ").__()   
                                ...
                                .select().attrClass("custom-select").attrId("graphiqueListe")
                                    ...
                                    .option().text("bar").__()
                                    .option().text("doughnut").__()
                                    .option().text("horizontalBar").__()
                                    .option().text("polarArea").__()
                                .__()
                        .__()
