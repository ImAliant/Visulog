...
set CLASSPATH=%APP_HOME%\lib\cli.jar;%APP_HOME%\lib\analyzer.jar;%APP_HOME%\lib\config.jar;%APP_HOME%\lib\gitrawdata.jar


@rem Execute cli
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CLI_OPTS%  -classpath "%CLASSPATH%" up.visulog.cli.CLILauncher %*
